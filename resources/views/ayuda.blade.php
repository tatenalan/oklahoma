...
@section('main')
  <div class="container">
        <h5 class="centrado titulo">Preguntas frecuentes</h5>
          ...
          <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
              ...
              <div class="card-body col-lg-6 col-sm-12 col-md-12">
                <img src="/img/size-chart.png" alt="">
              </div>
              <div class="card-body col-lg-6 col-sm-12 col-md-12">
        ...
        <h5 class="centrado titulo">Como comprar</h5>
        <div class="accordion" id="accordionExample">
          <div class="card">
        ...
        <h5 class="centrado titulo">Devoluciones</h5>
        <div class="accordion" id="accordionExample">
          <div class="card">
