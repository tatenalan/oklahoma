  ...
  <body>
    <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="home.php"><img class="logo" src="img/Logo2.png" alt = "Logo"></a>
        ...
        <div class="barra collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            ...
            <ul class="navbar-nav usuario">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="signin.php"><i class="fas fa-sign-in-alt"></i> Iniciar Sesion</a>
                  </li>
        ...
        <div class="row">
          <div class="col-xs-12 col-md-4 col-lg-4">
            ...
            <ul>
              ...
              <li><a href="ayuda.php">Guia de talles</a> |</li>
              <li><a href="ayuda.php">Cambios y devoluciones</a> |</li>
              <li><a href="ayuda.php">FAQ</a> |</li>
              <li><a href="nosotros.php">Donde estamos</a> </li>
            </ul>
          </div>
          <div class="col-xs-12 col-md-4 col-lg-4">
